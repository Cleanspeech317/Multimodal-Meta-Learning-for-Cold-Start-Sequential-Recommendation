...
sasrec_meta_train_log=$up_log_dir/SASRec.item-emb-gen.nn-10.log
...
do
    ...
    do
        meta_train_log=$up_log_dir/attention-fusion.meta-train.IEG.$attention_learning_rate."$mlp_hidden_size".nn-10.log
        meta_test_log=$down_log_dir/attention-fusion.meta-test.IEG.$attention_learning_rate."$mlp_hidden_size".nn-10.log
