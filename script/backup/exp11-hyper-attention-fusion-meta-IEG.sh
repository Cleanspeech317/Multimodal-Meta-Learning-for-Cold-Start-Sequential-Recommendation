...
do
    ...
    do
        meta_train_log=$up_log_dir/attention-fusion.meta-train.IEG.$attention_learning_rate."$mlp_hidden_size".log
        meta_test_log=$down_log_dir/attention-fusion.meta-test.IEG.$attention_learning_rate."$mlp_hidden_size".log
