...
Our library includes 74 recommendation algorithms, covering four major categories:
...
+ **Comprehensive benchmark models and datasets.** We implement 74 commonly used recommendation algorithms, and provide
